    ...
    >
      <div className="row">
        <div className="cmn--form--group form-group col-md-6">
          ...
          <div className="input-group">
            ...
            <input
              type="text"
              className="form-control cmn--form--control checkUser"
        ...
        <div className="cmn--form--group form-group col-md-6">
          <label className="cmn--label text--white">E-Mail Address</label>
          <div className="input-group">
            <span className="input-group-text">
        ...
        <div className="cmn--form--group form-group col-md-6">
          <label className="cmn--label text--white">Country</label>
          <div className="input-group">
            <span className="input-group-text">
        ...
        <div className="cmn--form--group form-group col-md-6">
          <label className="cmn--label text--white">Mobile</label>
          <div className="input-group">
            <span className="input-group-text mobile-code"></span>
        ...
        <div className="col-md-6 cmn--form--group form-group">
        ...
        <div className="col-md-6 cmn--form--group form-group">
          <label className="cmn--label text--white">Confirm Password</label>
          <div className="input-group">
            <span className="input-group-text">
              <i className="las la-key"></i>
            </span>
      ...
      <div className="form-group">
        ...
        <span>
          ...
          ,
          <Link className="text--base" href="/policy/terms-of-service/94">
            Terms Of Service
          </Link>
          ,
          <Link className="text--base" href="/policy/privacy-policy/92">
            Privacy Policy
          </Link>
        </span>
      </div>
