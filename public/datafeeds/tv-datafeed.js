        ...
        137: (e, t) => {
          ...
          (t.hu = void 0),
            (t.hu = function (e, t) {
              if (!e)
                throw new Error(
                  "Assertion failed".concat(t ? ": ".concat(t) : "")
                );
            });
        },
      },
      ...
      (() => {
        ...
        class i {
            ...
            (this._socket = new WebSocket(this._prepareUrl())),
              (this._socket.onmessage = (e) => {
                if ("string" != typeof e.data)
                  throw new TypeError(
                    `The WebSocket message should be a string. Recieved ${Object.prototype.toString.call(
                      e.data
                    )}`
                  );
                this._onData(e.data);
          ...
          _decode(e) {
            ...
            let s, o;
            do {
              if (e.substring(0, 3) !== n) return t;
              (s = ""), (o = "");
              const i = (e = e.substring(3)).length;
              for (let t = 0; t < i; t++) {
                if (
                  ((o = Number(e.substring(t, t + 1))),
                  Number(e.substring(t, t + 1)) !== o)
                ) {
                  (e = e.substring(s.length + n.length)), (s = Number(s));
                  break;
                }
                s += o;
              }
        ...
        class r {
          ...
          connect() {
            this.isConnected() ||
              (this._connecting && this.disconnect(),
              (this._connecting = !0),
          ...
          emit(e, t = []) {
            if (e in this._events) {
              const s = this._events[e].concat(),
                o = s.length;
              for (let e = 0; e < o; e++) s[e].apply(this, t);
            }
          }
          onConnect() {
        ...
        class l {
          ...
          getSessionId() {
            return this._socket && this._socket.transport
              ? this._socket.transport.sessionid
              : null;
          }
          send(e) {
            return this.isConnected()
              ? (this._socket.send(e), !0)
              : (this._queueMessage(e), !1);
          }
          ...
          _processMessageQueue() {
            0 !== this._queueStack.length &&
              ...
              this._logMessage(
                0,
                "Processed " + this._queueStack.length + " messages"
              ),
              (this._queueStack = []));
          }
          _onDisconnect(e) {
          ...
          _logMessage(e, t) {
            ...
            this._logger
              ...
              : ((s.message = `[${new Date().toISOString()}] ${s.message}`),
          ...
          _sendTelemetry(e, t) {
            ...
            this._telemetry
              ? this._flushTelemetryObject(s)
              : this._telemetryObjectsQueue.push(s);
          }
          ...
          _doConnect() {
            (this._socket &&
              (this._socket.isConnected() || this._socket.isConnecting())) ||
              (this._clearOnlineCancellationToken(),
          ...
          _tryConnect() {
            return (
              ...
              (this._lastConnectCallStack =
                new Error(
                  `WebSocket connect stack. Is connected: ${this.isConnected()}.`
                ).stack || ""),
              !this.isConnected() &&
                (this.disconnect(), this._reconnectWhenOnline(), !0))
            );
          }
          _clearOnlineCancellationToken() {
            this._onlineCancellationToken &&
              (this._onlineCancellationToken(),
              (this._onlineCancellationToken = null));
          }
          ...
          _reconnectWhenOnline() {
            if (navigator.onLine)
              return (
                this._logMessage(
                  0,
                  "Network status: online - trying to connect"
                ),
                this._doConnect(),
            ...
            this._logMessage(0, "Network status: offline - wait until online"),
              (this._onlineCancellationToken = (function (e) {
                ...
                this._logMessage(
                  0,
                  "Network status changed to online - trying to connect"
                ),
                  this._doConnect(),
          ...
          _onTelemetrySent(e) {
            "websocket_error" in e &&
              ((this._errorsCount = 0), (this._errorsInfoSent = !1));
          }
          _startPing() {
        ...
        let E = null,
          ...
          R = !1;
        function O(e) {
          (e = Math.max(y.ERROR, Math.min(y.DEBUG, e))), (T = e), P();
        }
        function A(e) {
          return (
        ...
        b.lget = (e, t) => {
          ...
          return (function (e, t) {
            ...
            for (
              s = e.length - 1;
              s >= 1 &&
              ((o += 8 * (1 + encodeURIComponent(e[s]).length)),
              !(
                s - 1 > 0 &&
                ((n = 8 * (1 + encodeURIComponent(e[s - 1]).length)), o + n > t)
              ));
              s--
            );
            return e.slice(s);
        ...
        function M(e, t, s, o) {
          ...
          if (
            ...
            e <= T && (!o.highRate || R) && (!E || o.id.match(E)))
          ) {
        ...
        (b.lon = (e, t) => {
          O(y.DEBUG),
            N.logNormal("Debug logging enabled"),
            (R = Boolean(e)),
            (E = t || null),
            P();
        }),
          (b.loff = () => {
            O(y.INFO), N.logInfo("Debug logging disabled");
          });
        function P() {
          try {
            f &&
              (localStorage.setItem(C, String(R)),
              localStorage.setItem(S, String(T)));
          } catch (e) {
            N.logWarn(
              `Cannot save logger state (level: ${T}, high-rate: ${R}) to localStorage: ${e.message}`
            );
          }
        }
        !(function () {
          ...
          Number.isNaN(e) && (e = y.WARNING),
            O(e),
            N.logNormal(`Init with settings - level: ${T}, high-rate: ${R}`);
        })(),
          b.performance && b.performance.now
            ? N.logNormal(
                `Sync logger and perf times, now is ${b.performance.now()}`
              )
            : N.logWarn("Perf time is not available");
        B("Common.InitData"), window.initData;
        var D;
        !(function (e) {
        ...
        class L {
          constructor(e) {
            (0, m.hu)("" !== e, "S3 base url must be a non-empty string"),
              (this._baseUrl = e);
          }
          getSymbolLogoUrl(e, t) {
            switch (
              ((0, m.hu)("" !== e, "logo id must be a non-empty string"), t)
            ) {
              case D.Medium:
          ...
          return 2 !== e.length
            ...
            : (function (e) {
              ...
              !(function (e) {
                return e.some(
                  (e) =>
                    (e.includes("currency") || e.includes("country")) && !X(e)
                );
              })(e)
            ? e.filter((e) => !X(e))
            : e;
        ...
        function x(e) {
          ...
          const o = e.country
              ? H.getCountryFlagUrl(e.country, D.Medium)
              : void 0,
            n = e.provider_id
              ? H.getProviderLogoUrl(e.provider_id, D.Medium)
              : void 0;
          return (o || n) && (t.exchange_logo = o || n), t;
        }
        function W() {
          let e, t;
          return {
        ...
        const K = B("LibraryTVDatafeed.Session", {
          highRate: !0,
        });
        function V(e) {
        ...
        function Y(e) {
          return [e.ticker, e.currency_code, e.unit_id, e.subsession_id]
            .filter((e) => !!e)
            .join("_#_");
        }
        function J(e) {
        ...
        class ae {
          constructor(e, t, s) {
            ...
            (this._dataHandleModule = new g()),
              ...
              this._symbolInfoHashes.add(Y(s)),
              this._wsBackendConnection.on("message", (e) =>
                setTimeout(() => this._onWsBackendMessage(e), 0)
              );
          }
          hasSymbol(e, t) {
            const s = this._symbolInfoHashes.has(Y(e)),
          ...
          async resolveSymbol() {
            return void 0 !== this._symbolInfo
              ? this._symbolInfo
              : (this._isSessionCreated ||
                ...
                (this._symbolId = ce()),
                this._sendRequest("resolve_symbol", [
                  this._sessionId,
                  this._symbolId,
                  this._symbolStringForResolve,
                ]),
          ...
          async getBars(e, t) {
            return (
              ...
              this._isSeriesCreated
                ? (this._sendRequest("request_more_data", [
                    this._sessionId,
                    this._seriesId,
                    t.countBack,
                  ]),
                ...
                : ((this._resolution = e),
                  ...
                  (this._seriesId = re()),
                  this._sendRequest("create_series", [
                    this._sessionId,
                    this._seriesId,
                    "t",
                    this._symbolId,
          ...
          unsubscribeBars(e) {
            delete this._realtimeSubscriberCallbacks[e],
              0 === Object.keys(this._realtimeSubscriberCallbacks).length &&
                (K.logInfo(
                  "Deleting session because there are no realtime subscribers"
                ),
                (this._isSessionCreated = !1),
                (this._isSeriesCreated = !1),
          ...
          _sendRequest(e, t) {
            ...
            K.logDebug(`Send message ${s}`), this._wsBackendConnection.send(s);
          }
          async _onWsBackendMessage(e) {
            ...
            if (
              ...
              if ((K.logDebug(`Receive message ${e}`), ee(t)))
                ...
                if (te(t)) {
                  ...
                  await this._tryInjectLogosFromQuoteData(
                    this._partialSymbolInfoForResolve.ticker,
                    e
                  ),
                    (this._symbolInfo = e),
                    this._symbolInfoHashes.add(Y(this._symbolInfo)),
                    this._symbolInfoHashes.add(
                      Y({
                        ...this._symbolInfo,
                  ...
                  return (
                    ...
                    K.logInfo(
                      `Resolved ${this._symbolInfo.ticker} hashes ${[
                        ...this._symbolInfoHashes.values(),
                      ].join(", ")}`
                    ),
                    void this._deferredResolveSymbolPromise.resolve(e)
                  );
                }
                if (Z(t)) this._deferredGetBarsPromise.reject(t.params[4]);
                else {
                  if (z(t))
                    return (
                      (this._isSeriesLoading = !0),
                      void this._clearGetBarsResult()
                    );
                  if (oe(t) || se(t))
                    if (this._isSeriesLoading)
                      this._getBarsResult.bars = ne(this._seriesId, t).concat(
                    ...
                    if (J(t)) {
                      ...
                      return (
                        0 === this._getBarsResult.bars.length &&
                          s &&
                          (this._getBarsResult.meta.noData = !0),
                        this._deferredGetBarsPromise.resolve(
                          this._getBarsResult
                        ),
                    ...
                    K.logError(
                      `Unhandled message: ${t.method}, ${JSON.stringify(
                        t.params
                      )}`
                    );
                  }
          ...
          _clearGetBarsResult() {
            (this._getBarsResult.bars = []), (this._getBarsResult.meta = {});
          }
          async _tryInjectLogosFromQuoteData(e, t) {
            try {
              ...
              const n = (function (e) {
                ...
                return (
                  e["base-currency-logoid"] &&
                    !e["base-currency-logoid"].startsWith(U) &&
                    (t["base-currency-logoid"] = H.getSymbolLogoUrl(
                      e["base-currency-logoid"],
                      D.Medium
                    )),
                  e["currency-logoid"] &&
                    !e["currency-logoid"].startsWith(U) &&
                    (t["currency-logoid"] = H.getSymbolLogoUrl(
                      e["currency-logoid"],
                      D.Medium
                    )),
                  e.logoid &&
                    !e.logoid.startsWith(U) &&
                    (t.logoid = H.getSymbolLogoUrl(e.logoid, D.Medium)),
                  e.provider_id &&
                    !e.provider_id.startsWith(U) &&
                    (t.provider_id = H.getProviderLogoUrl(
                      e.provider_id,
                      D.Medium
                    )),
                  e.country_code &&
                    !e.country_code.startsWith(U) &&
                    (t.country = H.getCountryFlagUrl(e.country_code, D.Medium)),
                  t
                );
              })(o);
              ...
              K.logError(
                `Unable to get quote data for ${e} while resolving symbol info: ${s}`
              );
            }
          }
        }
        ...
        class de {
          ...
          _ensureSessionForSymbol(e, t) {
            ...
            return (
              void 0 === s &&
                (le.logInfo(
                  `Creating session for ${e.ticker} ${t || "(no resolution)"}`
                ),
                (s = new ae(
        ...
        const _e = B("LibraryTVDatafeed.QuotesProvider", {
            highRate: !0,
          }),
          ue = [
            "ch",
        ...
        class me {
          ...
          async getQuotes(e, t, s) {
            try {
              ...
              _e.logDebug(
                `getQuotes ${JSON.stringify(e)} ${JSON.stringify(s)}`
              ),
                t(s);
            } catch (e) {
          ...
          subscribeQuotes(e, t, s, o) {
            ...
            for (const e of n) {
              ...
              void 0 === t
                ? (i.push(e), this._listenerGuidsBySymbol.set(e, new Set([o])))
                : t.add(o);
            }
          ...
          async _getQuoteData(e) {
            ...
            this._addSymbols(s);
            const o = e
                .map((e) => this._quoteCompletionPromises.get(e))
                .filter(Boolean),
              n = new Promise((e) => setTimeout(e, 5e3));
          ...
          _onMessage(e) {
            ...
            if ("protocol_switched" !== o.method) {
              if ("protocol_error" === o.method)
                return (
                  _e.logError(e), void this._wsBackendConnection.disconnect()
                );
              ...
              if ("qsd" === o.method || "quote_completed" === o.method)
                switch ((_e.logDebug(`Receive message ${e}`), o.method)) {
                  case "qsd": {
                    const [, e] = o.params;
                    if ("error" === e.s) {
                    ...
                    const i = e.n,
                      r =
                        null !== (t = this._listenerGuidsBySymbol.get(i)) &&
                        void 0 !== t
                          ? t
                          : [],
                      c = {
                    ...
                    for (const t of r)
                      null === (s = this._callbackByListenerGuid.get(t)) ||
                        void 0 === s ||
                        s([e]);
                    break;
                  }
          ...
          _onConnect() {
            this._isConnected
              ? _e.logWarn("_onConnected called again")
              : ((this._isConnected = !0),
                this._sendRequest("quote_create_session", [this._sessionId]),
                this._sendRequest("quote_set_fields", [
                  this._sessionId,
                  ...ue,
                  ...ge,
                ]));
          ...
          _sendRequest(e, t) {
            ...
            _e.logDebug(`Send message ${s}`), this._wsBackendConnection.send(s);
          }
        }
        const be = B("Fetch");
        function fe(e, t, s = {}) {
        ...
        class ye {
          ...
          async getTimescaleMarks(e, t, s, o) {
            ...
            return r
              ? (this._populateEarningsMarkers(r, n, i, t, s),
          ...
          _populateDividendsMarkers(e, t, s, o, n) {
            ...
            const c = e.dividend_amount_recent,
              ...
              l = [
                "Dividends",
                `Ex Date: \t${new Date(1e3 * r).toDateString()}`,
                `Amount: \t${c.toFixed(2)}`,
              ];
        ...
        const we = new RegExp("^http(s)?://");
        class ke extends class {
          constructor(e, t, s, o, n, i, r, c) {
            var a;
            (this._isConnected = !1),
              (this._searchResultExchangePredicate = (e) =>
                this._exchangeAllowDeny.isExchangeAllowed(e.exchange) ||
                (void 0 !== e.prefix &&
                  this._exchangeAllowDeny.isExchangeAllowed(e.prefix))),
              (this._wsBackendConnection = e),
              ...
              (this._options = c),
              (this._token = (a = null == c ? void 0 : c.token)
                ? `widget_user_token-${a}Â£-!${Ee(ve())}`
                : void 0),
          ...
          async searchSymbols(e, t, s, o) {
            const n = new URL(
              "https://symbol-search.tradingview.com/local_search/"
            );
            ...
            try {
              ...
              o(
                (await e.json())
                  .filter(this._searchResultExchangePredicate)
                  .map((e) => {
                    var t;
                    const s = x(e),
            ...
            this._resolveProvider
              ...
              .catch((e) => {
                e instanceof Error
                  ...
                  : s(
                      "string" != typeof e
                        ? "An unknown error has occurred while trying to resolve the symbol."
                        : e
                    );
              });
          }
          getBars(e, t, s, o, n) {
            this._historyProvider
              .getBars(e, t, s)
              .then((e) => o(e.bars, e.meta))
              .catch((e) => {
                e instanceof Error
                  ? n(
                      `An error has occurred within the datafeed. Error reported: ${e.message}`
                    )
                  : n("An unknown error has occurred with the datafeed.");
              });
          }
          ...
          _onConnect() {
            this._isConnected
              ? Ie.logError("_onConnected called again")
