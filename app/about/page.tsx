              ...
              <div className="header-wrapper">
                ...
                <ul className="menu">
                  ...
                  <li>
                    <a
                      className="active"
                      href="https://www.cryptoplustrader.com/about"
                    >
                      About
                    </a>
                  </li>
                  ...
                  <li>
                    <a href="https://www.cryptoplustrader.com/contact" className="">
                      Contact
                    </a>
                  </li>
                </ul>
              ...
              <div className="col-md-6 col-lg-4">
                <div className="feature__item">
                  ...
                  <div className="feature__content">
                    ...
                    <p>
                      We keep you up-to-date with the latest on crypto trading
              ...
              <div className="col-md-6 col-lg-4">
                <div className="feature__item">
                  ...
                  <div className="feature__content">
                    <h6 className="feature__title">Best Payout</h6>
                    <p>
                      Trade profits rise to as much as 28.3% per win which sits
                      at the table of some of the highest in the game.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="post__item h-100">
                  ...
                  <div className="post__content">
                    ...
                    <div className="blog-short-desc">
                      <a href="https://www.cryptoplustrader.com/blog/105/trading-for-beginners">
                        Trading for beginners can be exciting – and
                        overwhelming. That’s why we’ve outlined everything you
                  ...
                  <div className="post__content">
                    ...
                    <div className="blog-short-desc">
                      <a href="https://www.cryptoplustrader.com/blog/104/introduction-to-cryptocurrency-trading">
                        ...
                        cryptocurrency price movements via a CFD trading
                        account, or buying...
                      </a>
                    </div>
                  </div>
